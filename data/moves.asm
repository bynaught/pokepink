...
MoveEnd:
	...
	move FOCUS_ENERGY, ATTACK_UP1_EFFECT,            0, NORMAL,   100, 30 ; changed to attack up
	...
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,   100, 30
	...
	move FURY_SWIPES,  TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,   100, 15
	...
	move HARDEN,       PROTECT_EFFECT,               0, NORMAL,   100, 10 ; PROTECT
